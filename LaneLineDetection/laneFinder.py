import cv2
import numpy as np
from LaneLineDetection.laneLineFinder import LaneLineFinder
import math

class LaneFinder():
    """
    This class manages the lane finding operation.
    It has a process_image method that takes in an image (RGB) and finds the lane lines 
    ...
    def __init__(self,
        ...
        self.left_line = LaneLineFinder(warped_size, self.x_pixels_per_meter, self.y_pixels_per_meter, kind='LEFT')
